...
`hrbrthemeslite` : Additional Themes and Theme Components for 'ggplot2' (no spell checker version)
--------------------------------------------------------------------------------------------------
...
``` r
devtools::install_github("hrbrmstr/hrbrthemeslite")
```
...
``` r
library(hrbrthemeslite)
library(testthat)

date()
## [1] "Mon Feb 27 13:52:21 2017"

test_dir("tests/")
## testthat results ========================================================================================================
## OK: 9 SKIPPED: 0 FAILED: 0
## 
## DONE ===================================================================================================================
```
